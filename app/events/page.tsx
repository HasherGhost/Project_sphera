  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-1000">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Event Card */}
        <div className="glass-panel rounded-3xl overflow-hidden group hover:-translate-y-1 hover:border-blue-500/30 transition-all duration-300">
          <div className="h-40 bg-gradient-to-br from-indigo-900 to-blue-900 relative">
            ...
            <div className="absolute bottom-4 left-4 bg-white/10 backdrop-blur rounded-xl p-2 border border-white/20 text-center w-14">
              <span className="block text-xs text-gray-300 uppercase">Oct</span>
              <span className="block font-title text-xl text-white font-bold">24</span>
            </div>
          </div>
          <div className="p-6">
            <h3 className="font-title text-lg font-bold text-white mb-1">Global Tech Summit 2026</h3>
